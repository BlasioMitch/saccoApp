      ...
      <div className="hidden md:flex w-2/3 bg-custom-bg-primary dark:bg-custom-bg-primary p-8 flex-col justify-center">
        ...
        <div className="flex gap-4">
          <button 
            ...
            className="w-full md:w-auto h-12 px-6 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors"
          >
            Get Started
          </button>
          <button 
            // onClick={() => navigate('/about')}
            className="w-full md:w-auto h-12 px-6 border border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition-colors"
          >
            Learn More
          </button>
        </div>
